...
- [基于镜像清单构建](/docs/advanced/k8s/cluster-image/build-image-image-list)
- [基于部署清单构建](/docs/advanced/k8s/cluster-image/build-image-manifests)
- [基于helm-charts构建](/docs/advanced/k8s/cluster-image/build-image-helm_charts)
- [基于二进制构建](/docs/advanced/k8s/cluster-image/build-image-binary)
- [基于go-template构建](/docs/advanced/k8s/cluster-image/build-image-go_template)
- [基于exec和scp构建](/docs/advanced/k8s/cluster-image/build-image-scp_exec)
