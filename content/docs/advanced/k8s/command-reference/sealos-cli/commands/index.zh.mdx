...
有关安装说明，请参见[下载 Sealos 命令行工具](/docs/advanced/k8s/getting-started/install-cli)； 如需安装 Kubernetes 集群，请参见[安装 Kubernetes 集群](/docs/advanced/k8s/getting-started/deploy-kubernetes)。